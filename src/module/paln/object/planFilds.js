export const plan_filds_input = () => [
    { label: 'تاریخ ایجاد', value:'creation_date' },
    ...
    { label: 'تاریخ شروع جمع آوری وجوه', value: 'underwriting_start_date'},
    { label: 'تاریخ پایان جمع آوری وجوه', value: 'underwriting_end_date'},
    { label: 'تاریخ شروع اجرای طرح', value: 'project_start_date'},
    { label: 'تاریخ پایان اجرای طرح', value: 'project_end_date'},
  ...
  export const plan_filds_textarea = () => [
