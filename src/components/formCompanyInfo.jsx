                          ...
                          >
                            <Link
                              ...
                              sx={{
                                fontSize: '14px',
                                fontWeight: 'medium',
                                color: localData.Lock_latest_insurance_staf ? '#9e9e9e' : '#1e88e5',
                                '&:hover': {
                            ...
                            <Button
                              ...
                              sx={{
                                color: localData.Lock_latest_insurance_staf ? '#e0e0e0' : '#e53935',
                                '&:hover': {
                                  color: localData.Lock_latest_insurance_staf
                                    ? '#e0e0e0'
                                    : '#c62828',
                        ...
                        {typeof localData.bank_account_turnover === 'string' ? (
                          ...
                          >
                            ...
                            <Button
                              ...
                              sx={{
                                color: localData.Lock_bank_account_turnover ? '#e0e0e0' : '#e53935',
                                '&:hover': {
                                  color: localData.Lock_bank_account_turnover
                                    ? '#e0e0e0'
                                    : '#c62828',
